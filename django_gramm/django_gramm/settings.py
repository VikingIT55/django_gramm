...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY_ = os.getenv("SOCIAL_AUTH_GOOGLE_OAUTH2_KEY_")
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET_ = os.getenv("SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET_")
SOCIAL_AUTH_GITHUB_KEY_ = os.getenv("SOCIAL_AUTH_GITHUB_KEY_")
SOCIAL_AUTH_GITHUB_SECRET_ = os.getenv("SOCIAL_AUTH_GITHUB_SECRET_")
